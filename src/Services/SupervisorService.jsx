...
const customer_base_url="http://ec2-3-136-255-165.us-east-2.compute.amazonaws.com:8081/api/supervisor"
const LOGIN_API_BASE_URL="http://ec2-3-136-255-165.us-east-2.compute.amazonaws.com:8081/api/supervisor";
